...
public class DirectChuteShapes {
    ...
    public static VoxelShape createShape(BlockState state) {
        Direction direction = state.getValue(DirectChuteBlock.FACING);
        DirectChuteBlock.Shape shape = state.getValue(DirectChuteBlock.SHAPE);

        boolean intersection = shape == DirectChuteBlock.Shape.INTERSECTION || shape == DirectChuteBlock.Shape.ENCASED;
